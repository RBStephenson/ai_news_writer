...
ai_news_writer could always use more documentation, whether as part of the
official ai_news_writer docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `ai_news_writer` repo on GitHub.
...
3. The pull request should work for Python 2.7, 3.5, 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/RBStephensno/ai_news_writer/pull_requests
...
$ pytest tests.test_ai_news_writer
